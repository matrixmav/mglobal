        ...
        if ($_GET) {
  	     ...
  	     <td colspan="2"></td>
            ...
            $html2pdf->output($path . $userObject->name . 'invoice.pdf', 'F');
                ...
                $config['body'] = 'Thank you for your order! Your invoice has been attached in this email.';
                $config['file_path'] = $path.$userObject->name.'invoice.pdf';        
               CommonHelper::sendMail($config);
           
        }
Yii::app()->session['transactionid'] = "";
Yii::app()->session['amount'] = "";
Yii::app()->session['package_id'] = "";
Yii::app()->session['transaction_id'] = "";
Yii::app()->session['domain'] = "";
