...
//            $stateObject = $stateModel = State::model()->getStateByName($stateCondition);
           ...
           $basicPackageObject = Package::model()->findAll(array('condition'=>'type=1','status'=>1,'order' => 'name ASC','limit' => '3'));
           
           $advancePackageObject = Package::model()->findAll(array('condition'=>'type=2','status'=>1,'order' => 'name ASC','limit' => '3'));
           
           $proPackageObject = Package::model()->findAll(array('condition'=>'type=3','status'=>1,'order' => 'name ASC','limit' => '3'));
