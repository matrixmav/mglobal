	...
	<div class="row">
		<div class="">
			<div class="col-md-offset-3 col-md-9">
				...
				<a class="btn default" href="/admin/origin"><?php echo Yii::t('translation','Cancel');?></a>			
			</div>
		</div>
		<div class="col-md-6">
		</div>
...
<script src="/metronic/custom/form-validation-origin.js?ver=<?php echo strtotime("now");?>"></script>
