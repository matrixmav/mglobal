...
$this->breadcrumbs=array(
		'Equipments'=>array('/admin/equipment'),
		'Equipment'
);
	...
	<div class="form-group">
		...
		<div class="col-md-7">
			<div data-error-container="#form_2_membership_error" class="radio-list">
				<label>
				<input type="radio" value="room" name="Equipment[type]" <?php echo ($model->type=="room")?"checked":"";?>></span>
				Room </label>
				<label>
				<input type="radio" value="hotel" name="Equipment[type]" <?php echo ($model->type=="hotel")?"checked":"";?>>
				Hotel </label>
			</div>
			<span for="Equipment[type]" class="help-block"></span>
		</div>
	</div>
...
<script src="/metronic/custom/form-validation-equipment.js?ver=<?php echo strtotime("now");?>"></script>