...
$this->breadcrumbs=array(
		'Equipments'=>array('/admin/equipment/index/type/hotel'),
		'Hotel'
);
?>
<div class="row noMargin">
	<div class="col-md-12">
		<?php  $this->renderPartial('_search',array('model'=>$model,'type'=>'hotel')); ?>
	</div>
</div>
<div class="row">
	<div class="col-md-12">
...
<h4><?php echo Yii::t('translation','Hotels'); ?></h4>
		...
		array( 
			...
			'buttons'=>array(
				...
				'Delete' => array(
					...
					'url'=>'Yii::app()->createUrl("admin/equipment/delete", array("id"=>$data->id,"type"=>"hotel"))',
				),
			),
		),
	),
...
<script>
   ...
   PortletDraggable.init();
	...
	$.ajax({
		...
		data: "type=hotel&orderId="+$("#position").val()+"&searchId="+checkBox,
		success:function(result) {
			if(result.status=="SUCCESS"){ 
				window.location.href = "/admin/equipment/index/type/hotel";
			}else {
