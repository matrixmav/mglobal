...
$this->breadcrumbs=array(
		'Home Ad Banners'=>array('/admin/homeAdBanner'),
		ucfirst($curAction).' AdBanner'
);
...
<div class="form-body">
	...
	<div class="form-group">	
		...
		<div class="col-md-7">			
			...
			<input type="hidden" id="banner_image" name="HomeAdBanner[banner]" value="<?php echo $model->banner ?>">
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-md-7">
			<?php echo $form->dropDownList($model, 'ad_page', array('home'=>'Home', 'detail'=>'Hotel Detail','other'=>'Other'),array('class'=>'form-control select2me')); ?>			
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-md-7">
			<?php echo $form->dropDownList($model, 'ad_pos', array('top'=>'Top', 'bottom'=>'Bottom','left'=>'Left','right'=>'Right'),array('class'=>'form-control select2me')); ?>			
		</div>
	</div>
...
jQuery(document).ready(function() {  
   ...
   Dropzone.options.myAwesomeDropzone = {
        url: '/admin/homeAdBanner/dropzoneupload/id/<?php echo $model->id;?>',
        maxFiles: 1,
