...
<div class="col-md-7 col-sm-7">
    <a class="btn btn-primary" href="/admin/BuildTemp/templateheaderedit?id=<?php echo $bodyObject->id;?>">Header Code Edit</a>&nbsp;&nbsp;<a class="btn btn-info" href="/admin/BuildTemp/templatebodyedit?id=<?php echo $bodyObject->id;?>">Body Code Edit</a>&nbsp;&nbsp;<a class="btn btn-success" href="/admin/BuildTemp/templatefooteredit?id=<?php echo $bodyObject->id;?>">Footer Code Edit</a>
