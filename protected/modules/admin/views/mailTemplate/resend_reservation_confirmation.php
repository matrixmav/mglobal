                        ...
                        <tr>
                            <td><p style="font-size: 14px;">
                                ...
                                <p style="margin-top:0px;font-size:14px;line-height: 23px;">Reservation number : <strong><?php echo $reservationObject->nb_reservation; ?></strong><br>
                                    ...
                                    Expected arrival time : <strong>
                                        <?php echo ($reservationObject->arrival_time)?$reservationObject->arrival_time:""; ?></strong></p></td>
                        </tr>
                        <tr>
                            <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr>
                                        <td><a href="<?php echo $baseUrl.'/reservation/edit?hotelId='.$hotelObject->id .'&roomId='. $roomObject->id . '&date='. $reservationObject->res_date .'&resnb='. base64_encode($reservationObject->id); ?>" style="border: 1px solid #000;background: #fff;color:#000;padding-top:2px;padding-bottom:2px; text-decoration:none; display: inline-block;">&nbsp;&nbsp;&nbsp;&nbsp;MODIFY&nbsp;&nbsp;&nbsp;&nbsp;</a>&nbsp;
