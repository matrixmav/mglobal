        ...
        <table width="980" align="center" cellpadding="0" cellspacing="0" style="border: 12px solid #eeeeee; font-family:arial;font-size: 14px;line-height: 18px;">
            ...
            <tr>
                <td><table width="770" align="center" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            <td><p style="font-size: 14px;"><span style="font-size: 18px;line-height: 25px;font-family: arial;">Account Information !</span>
                                    <br>
                                </p>
                                <p style="font-family: arial;font-size: 18px;margin-bottom:5px;padding-top:12px;">New Account Detail</p>
                                <p style="margin-top:0px;font-size:14px;line-height: 23px;">
                                    Name : <strong><?php echo $managerName; ?></strong><br>
                                    <a href="<?php echo $baseUrl."/admin/default/managerlogin"; ?>">Click here to check the contract form.</a><br>
                                    Use the following credential for logging:<br>
                                    Email: <strong><?php echo $hmanager_email; ?></strong><br>
