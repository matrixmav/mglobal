...
$this->breadcrumbs=array(
		'Customer'=>array('/admin/customer/blacklist'),
		'Customer'
);
...
<div class="portlet box green">
	...
	<div class="portlet-body form">
		...
		$form=$this->beginWidget('CActiveForm', array(
			'action'=>Yii::app()->createUrl($this->route)."?id=$model->id&type=blacklist",
		...
		?>		
			<div class="form-body">
				...
				<div class="form-group">
					<label class="control-label col-md-3">
						<?php echo $model->getAttributeLabel('comment'); ?><span class="required"> * </span>
					</label>
					<div class="col-md-7">
