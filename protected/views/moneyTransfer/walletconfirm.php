               ...
               <div class="form-group">
                    ...
                    <div class="col-lg-8">
                        ...
                        <form action="<?php echo Yii::app()->params['paypalurl']; ?>" method="post" id="frmPayPal">
                            ...
                            <input type="hidden" name="cancel_return" value="<?php echo Yii::app()->params['walletReturnUrl']; ?>?transaction_id=<?php echo $transactionId; ?>&type=cancelled">
                            <input name="notify_url" value="<?php echo Yii::app()->params['walletReturnUrl']; ?>/PayPal/ipn.php" type="hidden">
                            <input type="hidden" id="return" name="return" value="<?php echo Yii::app()->params['walletReturnUrl']; ?>?transaction_id=<?php echo $transactionId; ?>&type=success">
                        </form>
                    </div>
