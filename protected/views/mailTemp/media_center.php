    ...
    <tr>
          ...
          <tbody>
            <tr>
                ...
                <td width="90%" valign="middle" align="left" style="line-height:22px; color: #828282; font-size:16px; font-family:'Nunito'"> Dear <?php echo ucwords($userObjectArr['name']);?> ,</td>
                <td width="5%" valign="middle" align="center" style="line-height:22px; color: #828282; font-size:16px; font-family:'Nunito'"> </td>
            </tr>
            </tbody>
            </table>
    ...
    <tr>
          ...
          <tbody>
            ...
            <tr>
                 ...
                 Thankyou ! we recived your request for <?php echo ucwords($userObjectArr['type']); ?>
                  </td>
                   <tr>
            	  <td height="20" bgcolor="" style=""></td>
            </tr>
