...
<tr>
          ...
          <tbody>
            <tr>
                ...
                <td width="90%" valign="middle" align="left" style="line-height:22px; color: #828282; font-size:16px; font-family:'Nunito'"> Hello <?php echo ucfirst($userObjectArr['to_name']);?></td>
                <td width="5%" valign="middle" align="center" style="line-height:22px; color: #828282; font-size:16px; font-family:'Nunito'"> </td>
            </tr>
            </tbody>
            </table>
    ...
    <tr>
          ...
          <tbody>
            ...
            <tr>
                 ...
                 We are pleased to inform you that your direct referral income of user <?php echo ucfirst($userObjectArr['user_name']);?> has been credited your wallet</td>
                  </tr>
