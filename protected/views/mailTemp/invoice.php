                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td width="50%" valign="top" align="center" style="line-height:22px; color: #828282; font-size:16px; font-family:'Nunito'"> 
                                                                                        <table width="100%" cellspacing="0" cellpadding="0" border="0">
                                                                                            <tbody>
                                                                                                <tr>
                                                                                                    <td>T0 : Mr <?php echo ucwords($invoiceArr['full_name']);?></td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td> <?php echo ucwords($invoiceArr['address']);?></td>
                                                                                                </tr>
                                                                                            </tbody>
                                                                                        </table>
                                                                                    </td>
                                                                                    ...
                                                                                    <td width="50%" valign="middle" align="center" style="line-height:22px; color: #828282; font-size:16px; font-family:'Nunito'"> 
                                                                                        <table width="100%" cellspacing="0" cellpadding="0" border="0">
                                                                                            <tbody>
                                                                                                        ...
                                                                                                        <table width="100%" cellspacing="0" cellpadding="0" border="0">
                                                                                                            <tbody>
                                                                                                                <tr>
                                                                                                                    ...
                                                                                                                    <td width="50%" bgcolor="#e4f4e3" valign="middle" height="30" align="left" style="line-height:22px; color: #828282; font-size:16px; font-family:'Nunito'"><?php echo $invoiceArr['name'];?></td>
                                                                                                                </tr>
                                                                                                                <tr>
                                                                                                                ...
                                                                                                                <tr>
                                                                                                                    ...
                                                                                                                    <td width="50%" bgcolor="#e0eec4" valign="middle" height="30" align="left" style="line-height:22px; color: #828282; font-size:16px; font-family:'Nunito'">#<?php echo $invoiceArr['transaction_id'];?></td>
                                                                                                                </tr>
                                                                                                                 <tr>
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td valign="middle" align="left" style="line-height:22px; color: #828282; font-size:16px; font-family:'Nunito'">Date : <?php echo $invoiceArr['created_at'];?>
                                                                                                    </td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td valign="middle" align="left" style="line-height:22px; color: #828282; font-size:16px; font-family:'Nunito'"> Email : <?php echo $invoiceArr['email'];?>
                                                                                                    </td>
                                                                                                </tr>
                                                                                            </tbody>
                                                                                        </table>
                                                                        ...
                                                                        <table width="100%" cellspacing="0" cellpadding="0" border="0">
                                                                            <tbody>
                                                                                <tr>     
                                                                                    ...
                                                                                    <td valign="middle" align="left" width="19%" style="line-height:22px; color: #828282; font-size:14px; font-family:'Nunito'"><?php echo $invoiceArr['package_name'];?></td>
                                                                                    <td valign="middle" align="left" width="30%" style="line-height:22px; color: #828282; font-size:14px; font-family:'Nunito'"><?php echo $invoiceArr['Description'];?>,
6 Static Pages, 1
<br>Contact
form, 2 Gallery</td>
                                                                                    <td valign="middle" align="middle" width="15%" style="line-height:22px; color: #828282; font-size:14px; font-family:'Nunito'">1 year</td>
                                                                                    <td valign="middle" align="center" width="22%" style="line-height:22px; color:#f15c2b;; font-size:14px; font-family:'Nunito'"> <?php echo $invoiceArr['package_price'];?></td>
                                                                                    <td width="2%" valign="middle" align="left" style="line-height:22px; color: #828282; font-size:14px; font-family:'Nunito'"></td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                            ...
                                                                            <tbody>
                                                                                <tr>     
                                                                                   ...
                                                                                   <td valign="middle" align="left" width="10%" style="line-height:22px; color: #828282; font-size:16px; font-family:'Nunito'">1</td>
                                                                                    ...
                                                                                    <td valign="middle"  width="30%"  align="left" style="line-height:22px; color: #477dc0; font-size:16px; font-family:'Nunito'"><?php echo $invoiceArr['domain'];?></td>
                                                                                     <td valign="middle" align="middle" width="15%" style="line-height:22px; color: #828282; font-size:16px; font-family:'Nunito'">1 year</td>
                                                                                    <td valign="middle"  width="22%"  align="center" style="line-height:22px; color: #6dbb5b; font-size:16px; font-family:'Nunito'"><?php echo (!empty($invoiceArr['domain_price'])) ? $invoiceArr['domain_price'] : "Free";?></td>
                                                                                    <td width="2%" valign="middle" align="left" style="line-height:22px; color: #828282; font-size:16px; font-family:'Nunito'"></td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                        ...
                                                                        <table width="100%" cellspacing="0" cellpadding="0" border="0">
                                                                            <tbody>
                                                                                ...
                                                                                <tr>     
                                                                                    ...
                                                                                    <td valign="middle"  width="15%" height="30" align="left" style="line-height:22px; color: #828282; font-size:16px; font-family:'Nunito'"> <?php echo (!empty($invoiceArr['Couponbody'])) ? $invoiceArr['Couponbody'] : "N/A";?></td>
                                                                                </tr>
                                                                                <tr>     
                                                                                    ...
                                                                                    <td valign="middle"  width="15%" height="30" align="left" style="line-height:22px; color: #828282; font-size:16px; font-family:'Nunito'"> <?php echo (!empty($invoiceArr['RPBody'])) ? $invoiceArr['RPBody'] : "N/A";?></td>
                                                                                </tr>
                                                                                <tr>     
                                                                                    ...
                                                                                    <td valign="middle"  width="15%" height="30" align="left" style="line-height:22px; color: #828282; font-size:16px; font-family:'Nunito'"> <?php echo (!empty($invoiceArr['paid_amount'])) ? $invoiceArr['paid_amount'] : "Free";?></td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                    </td>
