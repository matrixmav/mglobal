    ...
    <tr>
          ...
          <tbody>
            ...
            <tr>
                 ...
                 Oops!! Looks like you have forgotten your password please use the below verification code to reset your password 
                  </td>
                  </tr>
                  <tr>
            	  <td height="20" bgcolor="" style=""></td>
            ...
            <tr>
            	  <td height=""  valign="middle" align="left" style="line-height:22px; color: #6b6b6b; font-size:16px; font-family:'Nunito'">Once you have  entered the verification code, you'll be prompted to set a new password immediately. The code is valid for 10 minutes and usable only once
                  </td>
                  <tr>
                  <tr>
            	  <td height="20" bgcolor="" style=""></td>
