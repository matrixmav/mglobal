    ...
    <tr>
          ...
          <tbody>
            <tr>
                ...
                <td width="90%" valign="middle" align="left" style="line-height:22px; color: #828282; font-size:16px; font-family:'Nunito'"> Dear Admin ,</td>
                <td width="5%" valign="middle" align="center" style="line-height:22px; color: #828282; font-size:16px; font-family:'Nunito'"> </td>
            </tr>
            </tbody>
            </table>
    ...
    <tr>
          ...
          <tbody>
            ...
            <tr>
                 ...
                 New user subscribed with mGlobally site.
                  </td>
                   <tr>
            	  <td height="20" bgcolor="" style=""></td>
            </tr>
