        ...
        <table width="100%" cellspacing="0" cellpadding="0" border="0">
            <tbody>
                <tr>
                    ...
                    <td width="90%" valign="middle" align="left" style="line-height:22px; color: #828282; font-size:16px; font-family:'Nunito'"> Hello <?php echo ucfirst($model->full_name); ?></td>
                    <td width="5%" valign="middle" align="center" style="line-height:22px; color: #828282; font-size:16px; font-family:'Nunito'"> </td>
                </tr>
            </tbody>
        </table>
                    ...
                    <td width="90%" valign="middle" align="left" style="line-height:22px; color: #828282; font-size:16px; font-family:'Nunito'"> 
                        <table width="100%" cellspacing="0" cellpadding="0" border="0">
                            <tbody>
                                ...
                                <tr>
                                    <td height=""  valign="middle" align="left" style="line-height:22px; color: #3fb90f; font-size:16px; font-family:'Nunito'">
                                        <a href="<?php echo Yii::app()->getBaseUrl(true); ?>/user/confirm?activation_key=<?php echo $rand; ?>" style="color:#3fb90f; display:inline"><?php echo Yii::app()->getBaseUrl(true); ?>/user/confirm?activation_key=<?php echo $rand; ?></a>
                                    </td>
                                </tr>
                                <tr>
                                    <td height="20" bgcolor="" style=""></td>
