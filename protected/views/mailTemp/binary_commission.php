    ...
    <tr>
          ...
          <tbody>
            ...
            <tr>
                ...
                Hurray!!  You have got a little richer!
                  </td>
                  </tr>
            ...
            <tr>
            	 <td height=""  valign="middle" align="left" style="line-height:22px; color: #6b6b6b; font-size:16px; font-family:'Nunito'">
              Binary commission for previous day <date> has been generated.  Please login and check your reward point’s credit summary.
                  </td>
            </tr>
           ...
           <tr>
            	  <td height=""  valign="middle" align="left" style="line-height:22px; color: #6b6b6b; font-size:16px; font-family:'Nunito'">
            Continue to refer and encourage your subordinates to take benefit of our services.  Refer more… Earn more!!!
                  </td>
                  <tr>
                  <tr>
            	  <td height="20" bgcolor="" style=""></td>
          ...
          <tbody>
            ...
            <td width="5%"></td>
             <td width="8%"><a href=""> <img width="" border="0" src="<?php echo Yii::app()->getBaseUrl(true); ?>/email-images/skype.png"></a></td>
              <td width="37%" valign="middle" align="left" style="line-height:0px;color: #19bcf1;font-size:16px; font-family:'Nunito'"><a style="line-height:0px;color: #19bcf1; text-decoration:none;" href="">+525527895477</a> </td>
