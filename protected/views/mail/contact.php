        ...
        <table width="980" align="center" cellpadding="0" cellspacing="0" style="border: 12px solid #eeeeee; font-family:arial;font-size: 14px;line-height: 18px;">
            ...
            <tr>
                <td><table width="770" align="center" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            <td><p style="font-size: 14px;"><span style="font-size: 18px;line-height: 25px;font-family: arial;">Contact Information !</span>
                                    <br>
                                </p>
                                <p style="font-family: arial;font-size: 18px;margin-bottom:5px;padding-top:12px;">CONTACT DETAILS</p>
                                <p style="margin-top:0px;font-size:14px;line-height: 23px;">
                                    Name : <strong><?php echo $customerName; ?></strong><br>
                                    Telephone : <strong><?php echo $message['telephone']; ?></strong><br>
                                    <?php if(!empty($message['hotel_name'])) { ?>
                                        Hotel Name : <strong><?php echo $message['hotel_name']; ?></strong><br>
                                    <?php } ?>
                                    <?php if(!empty($message['company_name'])) { ?>
                                        Company Name : <strong><?php echo $message['company_name']; ?></strong><br>
                                    <?php } ?>
                                    <?php if(!empty($message['email'])) { ?>
                                        Email Address : <strong><?php echo $message['email']; ?></strong><br>
                                    <?php } ?>
                                    <?php if(!empty($message['position'])) { ?>
                                        Position : <strong><?php echo $message['position']; ?></strong><br>
                                    <?php } ?>
                                    
                                    Message : <?php echo $message['message']; ?></p></td>
                        </tr>
