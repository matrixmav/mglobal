...
<table summary="" border="0" width=100%>
	<tr>
		<td align=right>
		<a href="index.php?category=habillage&folder=settings&page=backgrounds&Proceed=1&type=">[<?php echo $CLICK_CLEAR_BGR;?>]</a>
		</td>
	</tr>
</table>
<br>
<?php
		...
		while ($file = readdir($handle)) 
		{
		    if ($file != "." && $file != ".." && $file != "Thumbs.db") 
			{
				...
				echo '<a href="index.php?category=habillage&folder=settings&page=backgrounds&Proceed=1&type='.$file.'">';
				
				echo "<img src='images/backgrounds/".$file."' width=100 height=100 border=0></a> &nbsp;&nbsp;&nbsp;&nbsp;";
			
							
				if($iFileCounter!=0 && $iFileCounter%5==0)	
				{
					echo "<br><br>";
				}
