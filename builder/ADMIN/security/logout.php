...
<?php
	...
	RenderTable("login_log",$oCol,$oNames,750,"WHERE action='logout' ORDER BY id desc  ","$EFFACER","id","index.php?action=logout&category=".$category);
			
?>

<script>
var HTType="1";
var HTMessage="<?php echo $HT_LO_LOGIN;?>";
