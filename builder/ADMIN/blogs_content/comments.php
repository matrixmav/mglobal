...
if(isset($Delete))
{
	...
	{
		ms_ia($CheckList);
		SQLDelete("comments","id",$CheckList);
	}
}
?>
		...
		<td class=basicText>
			...
			<table summary="" border="0">
				<tr>
					...
					<td class=basictext><b>List of the comments</b></td>
				</tr>
			  </table>
			...
			<?php
				...
				RenderTable("comments",$oCol,$oNames,"100%","WHERE user<>'administrator'  ",$EFFACER,"id","index.php?action=$action&category=".$category);
