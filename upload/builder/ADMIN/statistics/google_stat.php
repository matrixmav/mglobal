...
$arrTDSizes=array(200,"*");
RenderTable
(
	"statistics",
	array("previous_date","GoogleQuery"),
	array($DATE_MESSAGE,$QUERY),
	"100%",
	($strWhereQuery==""?"WHERE referer LIKE '%google.com%'":$strWhereQuery." AND referer LIKE '%google%'"),
	"",
	"",
	"index.php?category=statistics&action=google_stat"
);
?>
<script>
var HTType="1";
var HTMessage="<?php echo $HT_STAT_GOOGLE;?>";
