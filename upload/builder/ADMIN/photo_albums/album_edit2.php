		...
		<td width=25% align=center>
					...
					<table summary="" border="0">
				  	<tr>
						...
						<?php
							echo $arrHomeAlbumFormatDescription[1];
						?>
						<br><br>
						<img src="images/format/format_home_albums/1.gif" width="108" height="74" alt="" border="0">
						<br><br>
		...
		<td width=25% align=center>
			...
			<table summary="" border="0">
				  	<tr>
				  		...
				  		<td align=center>
						<?php
							echo $arrHomeAlbumFormatDescription[2];
						?>
						<br><br>
						<img src="images/format/format_home_albums/2.gif" width="108" height="74" alt="" border="0">
						<br><br>
		...
		<td width=25% align=center>
			<table summary="" border="0">
				  	<tr>
				  		...
				  		<td align=center>
						<?php
							echo $arrHomeAlbumFormatDescription[3];
						?>
						<br><br>
						<img src="images/format/format_home_albums/3.gif" width="108" height="74" alt="" border="0">
						<br><br>
		...
		<td width=25% align=center>
			...
			<table summary="" border="0">
				  	<tr>
				  		...
				  		<td align=center>
						<?php
							echo $arrHomeAlbumFormatDescription[4];
						?>
						<br><br>
						<img src="images/format/format_home_albums/4.gif" width="108" height="74" alt="" border="0">
						<br><br>
