...
<table summary="" border="0" width=100%>
	<tr>
		<td width=32><img src="images/icons<?php echo $DN;?>/wizard.gif" border="0" width="31" height="38" alt=""></td>
		<td class=basictext><b><?php echo $MANAGEMENT_FORMS;?></b></td>
	</tr>
</table>
<br>
...
function AddTextBox(){
	...
	if(false)
	{
		ElementPreview.innerHTML="<table width=180><tr><td class=previewTD><?php echo $NOM;?>:</td><td class=previewTD> <input name=fieldName type=textbox size=15></td></tr><tr><td class=previewTD><?php echo $TEXT_MESSAGE;?>:</td><td class=previewTD> <input name=fieldText type=textbox size=15></td></tr><tr><td class=previewTD><?php echo $TAILLE;?>:</td><td class=previewTD> <select name=fieldSize><option>10</option><option>20</option><option>30</option><option>40</option><option>50</option><option>60</option></select></td></tr><tr><td class=previewTD>Obligatory:</td><td><input type=checkbox name=obl onmousedown='javascript:OblChecked(this)'></td></tr><tr id=obl_tr style='visibility:hidden'><td colspan=2 class=previewTD>Message:<br><textarea cols=20 rows=3 id=obl_message></textarea></td></tr><tr><td class=previewTD>&nbsp;</td><td class=previewTD align=right><br><input onclick=\"javascript:RealAddTextBox()\" type=button class=adminButton value=\" <?php echo $AJOUTER;?> >>\"></td></tr></table>";
	}
	else
	{
...
generateJSValidationFunction(
				"ValidateStep1",
				array(array("FormName","empty",$FORM_NAME_EMPTY))
			);
?>
...
<?php echo $NOM;?>: <input type=text name=FormName name size=61>
<br><br>
...
<table summary="" border="0">
	<tr>
		...
		<td> <input type=text name="FormSubmit" size=50 value="submit"></td>
	</tr>
	<tr>
		<td><b><?php echo $EMAIL_RECEIVE;?>(*):</b></td>
		<td><input type=text name="ReceiveEmail" size=50 >
	...
	<tr>
		...
		<br>
				...
				<br>
				 <textarea cols=60 rows=6 name="FormMessage"><?php echo $X10;?><?php echo $THE_DATA_YOU_JUST;?></textarea>
...
<a href="index.php?category=tools&action=manage">
<font class=hl_text><?php echo $PUBLISH_THE_FORM;?></font>
</a>
</b>
<br>
...
<br><br><br>
<i><?php echo $FORM_NAME;?>:</i> <font class=hl_text><?php echo $FormName;?></font>
<br><br>
<i><?php echo $FORM_DESCRIPTION;?>:</i> <font class=hl_text><?php echo $FormDescription;?></font>
<br><br>

<i><?php echo $EMAIL;?>:</i> <font class=hl_text><?php if($ReceiveEmail=="") echo "[no email defined]";else echo $ReceivedEmail;?></font>
<br><br>

<?php
/*
<i><?php echo $FORM_LAYOUT;?>:</i> 

<form>
<?php 

$arrFormItems = explode("~~~~~", $FormCode);

			
if(sizeof($arrFormItems) == 2)
{
	echo stripslashes($arrFormItems[1]);
}
else
{
	echo stripslashes($FormCode);
}
