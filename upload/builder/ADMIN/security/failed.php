...
<?php
		...
		RenderTable("login_log",$oCol,$oNames,750,"WHERE action='error' ORDER BY id desc  ","$EFFACER","id","index.php?action=failed&category=".$category);
?>
	<script>
var HTType="2";
var HTMessage="<?php echo $HT_UN_LOGIN;?>";
