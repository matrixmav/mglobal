...
function ShowColorMenu(x,y){
	...
	function doColor(x) 
	{
		...
		document.getElementById(strDIV).style.background= x;//document.getElementById("color").innerHTML;
		document.getElementById(strField).value = x;//document.getElementById("color").innerHTML;
