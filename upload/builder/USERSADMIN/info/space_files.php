...
function DeleteFile(x)
{
	...
	{
		document.location.href="index.php?category=<?php echo $category;?>&action=<?php echo $action;?>&delfi="+x;
	}
}
...
function DeleteImage(x)
{
	if(confirm("<?php echo $M_ARE_YOU_SURE;?>"))	
	{
		document.location.href="index.php?category=<?php echo $category;?>&action=<?php echo $action;?>&delim="+x;
	}
}
</script>
<?php
...
RenderTable_BA
	(
	"blog_files",
	array("file_id","file_name","file_date","file_size","delete_file_js"),
