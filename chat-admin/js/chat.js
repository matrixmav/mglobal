...
function chatHeartbeat(){
	...
	$.ajax({
	  url: "/chat-admin/chat.php?action=chatheartbeat",
	  cache: false,
	  dataType: "json",
...
function closeChatBox(chatboxtitle) {
	...
	$.post("/chat-admin/chat.php?action=closechat", { chatbox: chatboxtitle} , function(data){	
	});
...
function startChatSession(){  
	$.ajax({
	  url: "/chat-admin/chat.php?action=startchatsession",
	  cache: false,
	  dataType: "json",
	  success: function(data) {
